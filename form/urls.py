...
urlpatterns = [
    ...
    path('user/article_list/', views.user_ariticle_list, name='user_article_list'),
    path('user/discussion_list/', views.user_discussion_list, name='user_discussion_list'),
    ...
    path('user/comment_list/', views.user_comment_list, name='user_comment_list'),
